      ...
      <section className="about" ref={aboutSectionRef}>
        <div className="about-header">
          <div className="container">
            <Copy type="lines">
              <h3>
                Un lieu où boissons artisanales, douceurs maison et instants de partage se retrouvent dans une ambiance chaleureuse.
              </h3>
            </Copy>

            <div className="section-footer">
              <Copy type="lines" trigger=".about" start="top 50%" delay={0.5}>
                <p className="sm">Fait maison</p>
              </Copy>
            </div>
          </div>
        </div>
