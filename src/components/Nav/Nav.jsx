...
const NAV_LINKS = [
  { label: "Accueil", href: "/", img: "/menu/menu-home.jpg" },
  { label: "Notre histoire",href: "/about", img: "/menu/menu-essence.jpg" },
  { label: "La carte", href: "/menu", img: "/menu/menu-carte.jpg" },
  { label: "Infos", href: "/reservation", img: "/menu/menu-book.jpg" },
];

const SOCIAL_LINKS = [
  { label: "Instagram", href: "https://www.instagram.com/republikcoffeeshop/" },
  { label: "Google", href: "https://www.google.com/maps/place/Republik+Coffee+Shop/@47.9012968,1.9031348,17z/data=!3m1!5s0x47e4e4d3de04ae1f:0xa00f197302341c22!4m6!3m5!1s0x47e4e557cb92a257:0xd6bce6fb94a6281f!8m2!3d47.9012968!4d1.9057097!16s%2Fg%2F11z7cm2521?entry=ttu&g_ep=EgoyMDI2MDYwMy4xIKXMDSoASAFQAw%3D%3D" },
];
    ...
    <>
      <nav className="nav-bar">
        ...
        <div className="nav-toggle" onClick={handleToggle}>
          ...
          <p id="nav-toggle-close">Fermer</p>
        </div>
      </nav>
